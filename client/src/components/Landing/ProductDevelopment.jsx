...
import innovationImage from '../../assets/innovation.avif';
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col">
      ...
      <h2 className="text-2xl text-center font-semibold text-teal-700 my-8">
        Ayush Product Development and Innovation
      </h2>
      ...
      <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md">
        <img 
          src={innovationImage} 
          alt="Ayush Product Development and Innovation" 
        ...
        <p className="mb-6">
          ...
          <a href="https://example.com" className="text-teal-600 hover:underline" target="_blank" rel="noopener noreferrer">
            official page
          </a>.
        </p>
